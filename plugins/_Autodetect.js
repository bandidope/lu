...
handler.before = async function (m, { conn, participants, groupMetadata}) {
    ...
    const fkontak = {
        ...
        message: {
            locationMessage: {
                name: "*Bot Lu 💜*",
                jpegThumbnail: await (await fetch('https://cdn.adoolab.xyz/dl/e03b7b11.png)).buffer(),
                vcard:
                    "BEGIN:VCARD\n" +
                    "VERSION:3.0\n" +
                    "N:;Storm bot;;;\n" +
    ...
    let pp = await conn.profilePictureUrl(m.chat, 'image').catch(_ => null) || 'https://cdn.adoolab.xyz/dl/e03b7b11.png
